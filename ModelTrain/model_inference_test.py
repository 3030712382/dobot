...
if __name__ == '__main__':
    ...
    model = Imitate_Model(ckpt_dir='./ckpt/carbat_slow', ckpt_name=model_name)
    model.loadModel()
    ...
    with h5py.File("/home/robot/datasets/dataset_package_test/train_data/episode_init_20.hdf5", 'r', rdcc_nbytes=1024 ** 2 * 2) as root:
